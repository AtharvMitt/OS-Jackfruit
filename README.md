...
| Name | SRN |
|------|-----|
| Atharv Mittal | PES1UG24CS091 |
| Atul Suresh | PES1UG25CS098 |
...
|-----------|-----------|----------------|
| exp1a | -5 (high priority) | ~19994ms |
| exp1b | +10 (low priority) | ~102ms |
...
|-----------|----------|----------------|
| exp2a | cpu_hog (CPU-bound) | ~11968ms |
| exp2b | io_pulse (I/O-bound) | ~2288ms |
